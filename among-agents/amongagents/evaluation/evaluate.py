                ...
                "content": [
                    {
                        ...
                        + "\n"
                        + "Ground Truth and The Incorrect Answer Typically Given by Humans as a Result of The Visual Illusion:"
                        + truth["conversations"][1]["value"]
                        + "Response of VLM:"
                        + item["answer"],
                    }
                ],
...
with open(
    "/home/terran/lingjunmao/illusion/MyDataset/color/eval_results/gpt.json", "w"
) as file:
